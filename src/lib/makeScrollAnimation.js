        ...
        const scrollStep = (timestamp) => {
            ...
            elements.forEach((el) => {
                ...
                if (direction === 'left' && scrollAmount > 0) {
                    scrollAmount = Math.max(scrollAmount - progress / scrollDuration * scrollDistance, 0);
                } else if (direction === 'right' && scrollAmount < scrollDistance) {
                    scrollAmount = Math.min(scrollAmount + progress / scrollDuration * scrollDistance, scrollDistance);
                }
